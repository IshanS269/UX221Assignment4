 ...
 */
function indoorsports_sanitize_checkbox( $checked ) {
	// Boolean check.
...
function indoorsports_switch_sanitization( $input ) {
    if ( true === $input ) {
        return 1;
    } else {
        return 0;
...
function indoorsports_sanitize_choices( $input, $setting ) {
    global $wp_customize; 
...
function indoorsports_sanitize_float( $input ) {
 ...
 */
function indoorsports_sanitize_hex_color( $hex_color, $setting ) {
 ...
 */
function indoorsports_sanitize_html( $html ) {
 ...
 */
function indoorsports_sanitize_image( $image, $setting ) {
 ...
 */
function indoorsports_sanitize_nohtml( $nohtml ) {
 ...
 */
function indoorsports_sanitize_number_absint( $number, $setting ) {
 ...
 *                    the setting default.
 */
function indoorsports_sanitize_range_value( $number, $setting ) {
 ...
 */
function indoorsports_sanitize_select( $input, $setting ) {
 ...
 */
function indoorsports_sanitize_url( $url ) {
	return esc_url_raw( $url );
}


/* Sanitization Text*/
function indoorsports_sanitize_text( $text ) {
	return wp_filter_post_kses( $text );
}

/* Sanitization Integer*/
function indoorsports_sanitize_integer( $input ) {
    if( is_numeric( $input ) ) {
        return intval( $input );
    }
}
